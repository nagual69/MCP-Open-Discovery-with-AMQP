  ...
  initializeNetworkTools() {
    const networkTools = [
      ...
      },
      {
        ...
        description: 'List all stored Proxmox credentials (no passwords shown).',
        schema: { type: 'object', properties: {} },
        command: async () => await proxmox_creds_list()
      },
      {
        name: 'proxmox_creds_remove',
        description: 'Remove a Proxmox credential by ID.',
        schema: { type: 'object', properties: { id: { type: 'string', description: 'Credential ID' } }, required: ['id'] },
